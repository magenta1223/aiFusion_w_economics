...
def pivot():
    ...
    rawTables = pd.read_csv("./results.csv")[['targetHorizon', 'nDistrict', 'EPU', 'slidingWindow', 'targetArea', 'valError_RMSE', 'model']]
    ...
    for nDisctrict in [8, 9]:
        ...
        for model in rawTables['model']:
            ...
            pivoted.to_csv(f"./results_pivot_{nDisctrict}_{model}.csv")
