CONFIG = {
    ...
    "targetFeature" : "Average Egrowth",

    # features shared across all the regions
    "commonFeatures" : ["logCPIDiff", "NFCI", "TMU", "TFU", "TRU", "USA EPU"],

    # region specific features
    "regionVariantFeatures" : ['Average EPU', 'Average Minimum Wage', 'Aggregate Initial Claim Growth'],
